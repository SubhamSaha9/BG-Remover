...
const Result = () => {
  ...
  const { image, resultImage } = useSelector((state) => state.credits);
  return (
    <div className="mx-4 my-3 lg:mx-44 mt-14 min-h-[72vh]">
      <div className="bg-white rounded-lg px-8 py-6 drop-shadow-sm">
        ...
        <div className="flex flex-col sm:grid grid-cols-2 gap-8">
          <div>
            <p className="font-semibold text-gray-600 mb-2">Oroginal</p>
            <img
          ...
          <div className="flex flex-col">
            ...
            <div className="rounded-md border border-gray-30 h-full relative bg-layer overflow-hidden">
